...
export interface ImageUploadOptions {
  // Upstream type declared this `=> void`, but every real implementation
  // (see components/editor/image-upload.ts) returns a boolean the caller
  // gates on — corrected here to match actual usage.
...
export const createImageUpload =
  ...
  (file, view, pos) => {
    ...
    const validated = validateFn?.(file) ?? true;
    if (!validated) return;
